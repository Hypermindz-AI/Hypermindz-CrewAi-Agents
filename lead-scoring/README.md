...
- Modify `src/lead_scoring/config/agents.yaml` to define your agents
- Modify `src/lead_scoring/config/tasks.yaml` to define your tasks
- Modify `src/lead_scoring/crew.py` to add your own logic, tools and specific args
- Modify `src/lead_scoring/main.py` to add custom inputs for your agents and tasks
