...
Inspect `content_marketing_ideas/main.py` to see the inputs and how to customize the crew.
...
- Modify `src/content_marketing_ideas/config/agents.yaml` to define your agents
- Modify `src/content_marketing_ideas/config/tasks.yaml` to define your tasks
- Modify `src/content_marketing_ideas/crew.py` to add your own logic, tools and specific args
- Modify `src/content_marketing_ideas/main.py` to add custom inputs for your agents and tasks
...
or
```bash
uv run content_marketing_ideas
```
