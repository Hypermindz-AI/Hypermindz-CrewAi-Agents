#!/usr/bin/env python
import sys
from content_marketing_ideas.crew import (
...
def run():
    ...
    """
    inputs = {
    "topic": "Main subject or theme (e.g., product, technology, service)",
    "company": "Name of the company or organization related to the topic",
    }
