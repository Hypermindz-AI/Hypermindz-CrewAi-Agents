...
def run():
    ...
    inputs = {
        "customer_name": "Full name of the customer or client",
        "customer_info": "Company or background info about the customer (e.g., their organization or industry)",
        "topic": "Subject or theme of discussion (e.g., product interest, technology topic)",
    }
